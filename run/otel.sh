...
k apply -f ../experiment-02/otel/global-collector/collector-config-map.yaml
k apply -f ../experiment-02/otel/global-collector/otel-collector.yaml
k apply -f ../experiment-02/otel/global-collector/otel-collector-service.yaml
k apply -f ../experiment-02/namespace/sock-shop.yaml
k apply -f ../experiment-02/namespace/monitoring.yaml
k apply -f ../experiment-02/otel/otel-operator/otel-instrumentation.yaml
k apply -f ../experiment-02/otel/otel-operator/otel-sidecar.yaml
k apply -f ../experiment-02/otel/app/app.yaml
